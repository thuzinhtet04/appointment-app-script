document.addEventListener("DOMContentLoaded", () => {
  ...
  async function initDatePicker() {
    try {
      ...
      showToast("Failed to load available dates. Please try again later.", "error")
  ...
  async function loadTimeSlots(date) {
    try {
      ...
      timeMessage.textContent = "Failed to load available times. Please try again."
      timeSlots.innerHTML = ""
      timeSlots.appendChild(timeMessage)
    } finally {
      isLoading = false
...
console.log(appointmentData)
    ...
    try {
      ...
      showToast(`Appointment booked successfully for ${formatDate(date)} at ${selectedTime}.`, "success")
